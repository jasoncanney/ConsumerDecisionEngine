...
namespace GenAdxCDE.Source.Model.Services.consumerhistoryservice
{
    ...
    public interface IConsumerHistorySvc : IService
    {
        ...
        consumerHistory getAConsumerHistory(int id);
        ...
        /// <summary>
        /// getConsumerHistoryDataSet
        /// The getConsumerHistoryDataSet method pulls only preference data for use by NRECO mahout recommender </summary>
        /// <param name="consumerHistory"> The consumerHistory to be updated</param>
        /// <returns> IDataModel </returns>
        /// <exception cref="ConsumerException">  </exception>

        IDataModel getConsumerHistoryDataSet();
