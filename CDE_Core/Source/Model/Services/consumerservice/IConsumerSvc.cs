...
namespace GenAdxCDE.Source.Model.Services.consumerservice
{
    ...
    public interface IConsumerSvc : IService
    {
        ...
        /// The findConsumer takes an ID as an argument and retrieves it through the ConsumerSvcImpl class </summary>
        ...
        /// <summary>
        ///  get single consumerID 
        /// The whatIsConsumerId takes in a consumer object as input and will pass it to the ConsumerSvcImpl </summary>
        /// <param name="consumer"> The consumer to be updated</param>
        /// <returns> void </returns>
        /// <exception cref="ConsumerException">  </exception>

        int whatIsConsumerID(string socemail);
