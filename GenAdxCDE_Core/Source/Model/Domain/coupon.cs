...
namespace GenAdxCDE.Source.Model.Domain
{
    ...
    public class coupon
    {
     ...
     /// then an InvalidClassException is thrown
        ...
        public coupon(int couponID, string couponTitle, string couponDescription, string couponValue, string couponStartActive, string couponEndActive, string couponLocationsZip) : base()
          {
